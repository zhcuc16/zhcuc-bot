...
/////////////////
const BotName = 'ZHCUC-BOT☄'; 
const instagram = 'https://instagram.com/zhcuc16'; 
const telegram = 'https://t.me/gada'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/zhcuc16';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@zhcuc16')
